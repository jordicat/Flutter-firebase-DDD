...
class _$NoteFormEventTearOff {
  ...
  _TodosChanged todosChanged(List<TodoItemPrimitive> todos) {
...
mixin _$NoteFormEvent {
  ...
  Result when<Result extends Object>({
    ...
    @required Result todosChanged(List<TodoItemPrimitive> todos),
  ...
  Result maybeWhen<Result extends Object>({
    ...
    Result todosChanged(List<TodoItemPrimitive> todos),
    Result saved(),
...
class __$TodosChangedCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_TodosChanged(
      todos == freezed ? _value.todos : todos as List<TodoItemPrimitive>,
    ));
  }
}
...
abstract class _TodosChanged implements NoteFormEvent {
  const factory _TodosChanged(List<TodoItemPrimitive> todos) = _$_TodosChanged;
